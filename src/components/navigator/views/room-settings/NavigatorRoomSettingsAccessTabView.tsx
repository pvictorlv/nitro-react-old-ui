            ...
            <div className={ 'p-2' }>
                <Column gap={ 1 }>
                    <Text className={ 'text-volter-bold' }
                          variant={ 'white' }>{ LocalizeText('navigator.roomsettings.roomaccess.caption') }</Text>
                    <Text variant={'white'}>{ LocalizeText('navigator.roomsettings.roomaccess.info') }</Text>
                </Column>
                <Column overflow="auto">
                    <Column gap={ 1 }>
                        <Text className={ 'text-volter-bold' }
                              variant={ 'white' }>{ LocalizeText('navigator.roomsettings.doormode') }</Text>
                        <Flex alignItems="center" gap={ 1 }>
                            <input className="form-check-input" type="radio" name="lockState"
                            ...
                            <Text variant={'white'}>{ LocalizeText('navigator.roomsettings.doormode.open') }</Text>
                        </Flex>
                        <Flex alignItems="center" gap={ 1 }>
                            <input className="form-check-input" type="radio" name="lockState"
                            ...
                            <Text variant={'white'}>{ LocalizeText('navigator.roomsettings.doormode.doorbell') }</Text>
                        </Flex>
                        <Flex alignItems="center" gap={ 1 }>
                            <input className="form-check-input" type="radio" name="lockState"
                            ...
                            <Text variant={'white'}>{ LocalizeText('navigator.roomsettings.doormode.invisible') }</Text>
                        </Flex>
                        <Flex fullWidth gap={ 1 }>
                            ...
                            { !isTryingPassword && (roomData.lockState !== RoomDataParser.PASSWORD_STATE) &&
                                <Text variant={'white'}>{ LocalizeText('navigator.roomsettings.doormode.password') }</Text> }
                            { (isTryingPassword || (roomData.lockState === RoomDataParser.PASSWORD_STATE)) &&
                                <Column gap={ 1 }>
                                    <Text variant={'white'}>{ LocalizeText('navigator.roomsettings.doormode.password') }</Text>
                                    <input type="password" className="form-control room-info-input col-4"
                                    ...
                                    { isTryingPassword && (password.length <= 0) &&
                                        <Text className={ 'text-volter-bold' } variant={ 'white' } small
                                              >
                    ...
                    <Column gap={ 1 }>
                        <Text className={ 'text-volter-bold' }
                              variant={ 'white' }>{ LocalizeText('navigator.roomsettings.pets') }</Text>
                        <Flex alignItems="center" gap={ 1 }>
                            <input className="form-check-input" type="checkbox" checked={ roomData.allowPets }
                                   onChange={ event => handleChange('allow_pets', event.target.checked) }/>
                            <Text variant={'white'}>{ LocalizeText('navigator.roomsettings.allowpets') }</Text>
                        </Flex>
                        <Flex alignItems="center" gap={ 1 }>
                            <input className="form-check-input" type="checkbox" checked={ roomData.allowPetsEat }
                                   onChange={ event => handleChange('allow_pets_eat', event.target.checked) }/>
                            <Text variant={'white'}>{ LocalizeText('navigator.roomsettings.allowfoodconsume') }</Text>
                        </Flex>
                    </Column>
                </Column>
            </div>
