...
export const LayoutGridItem: FC<LayoutGridItemProps> = props =>
{
    ...
    {
        const newClassNames: string[] = noBorder ? [ 'layout-grid-item' ]
            : [ 'layout-grid-item', 'border', 'border-2', 'border-muted', 'rounded' ];
    ...
    return (
        <Column center={ center } pointer position={ position } overflow={ overflow } column={ column }
                classNames={ getClassNames } style={ getStyle } { ...rest }>
