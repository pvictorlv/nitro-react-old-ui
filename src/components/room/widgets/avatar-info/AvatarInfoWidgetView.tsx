...
export const AvatarInfoWidgetView: FC<{}> = props =>
{
    ...
    const getMenuView = () =>
    {
        ...
        if (activeNameBubble) return <AvatarInfoWidgetNameView nameInfo={ activeNameBubble }
        ...
        if (avatarInfo)
        {
            switch (avatarInfo.type)
            {
                ...
                case AvatarInfoUser.PEER:
                {
                    ...
                    if (info.isOwnUser)
                    {
                        ...
                        return <AvatarInfoWidgetOwnAvatarView avatarInfo={ info } isDancing={ isDancing }
            ...
            //            onClose={ () => setAvatarInfo(null) }/>;
                ...
                {
                    return <AvatarInfoWidgetRentableBotView avatarInfo={ (avatarInfo as AvatarInfoRentableBot) }
                        onClose={ () => setAvatarInfo(null) }/>
                }
            }
        }
    ...
    const getInfostandView = () =>
    {
        ...
        {
            case AvatarInfoFurni.FURNI:
                return <InfoStandWidgetFurniView avatarInfo={ (avatarInfo as AvatarInfoFurni) }
                    onClose={ () => setAvatarInfo(null) }/>;
            case AvatarInfoUser.OWN_USER:
            case AvatarInfoUser.PEER:
                return <InfoStandWidgetUserView avatarInfo={ (avatarInfo as AvatarInfoUser) }
                    setAvatarInfo={ setAvatarInfo } onClose={ () => setAvatarInfo(null) }/>;
            case AvatarInfoUser.BOT:
                return <InfoStandWidgetBotView avatarInfo={ (avatarInfo as AvatarInfoUser) }
                    onClose={ () => setAvatarInfo(null) }/>;
            case AvatarInfoRentableBot.RENTABLE_BOT:
                return <InfoStandWidgetRentableBotView avatarInfo={ (avatarInfo as AvatarInfoRentableBot) }
                    onClose={ () => setAvatarInfo(null) }/>;
            case AvatarInfoPet.PET_INFO:
                return <InfoStandWidgetPetView avatarInfo={ (avatarInfo as AvatarInfoPet) }
                    onClose={ () => setAvatarInfo(null) }/>
        }
    }
    ...
    return (
        <>
            { isDecorating &&
                <AvatarInfoWidgetDecorateView userId={ GetSessionDataManager().userId }
            ...
            { (nameBubbles.length > 0) && nameBubbles.map((name, index) => <AvatarInfoWidgetNameView key={ index }
                nameInfo={ name }
                onClose={ () => removeNameBubble(index) }/>) }
            { (productBubbles.length > 0) && productBubbles.map((item, index) =>
            {
                return <AvatarInfoUseProductView key={ item.id } item={ item }
            ...
            { confirmingProduct && <AvatarInfoUseProductConfirmView item={ confirmingProduct }
