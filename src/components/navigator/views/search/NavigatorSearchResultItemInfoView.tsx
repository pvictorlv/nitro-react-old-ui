...
export const NavigatorSearchResultItemInfoView: FC<NavigatorSearchResultItemInfoViewProps> = props =>
{
    ...
    return (
        <>
            <Base pointer innerRef={ elementRef } className="icon icon-navigator-info"
                  onMouseOver={ event => setIsVisible(true) } onMouseLeave={ event => setIsVisible(false) }/>
                    ...
                    <NitroCardContentView overflow="hidden"
                        ...
                        <Flex gap={ 2 } overflow="hidden">
                            ...
                            <Column gap={ 1 }>
                                ...
                                <Flex
                                    className={ 'badge p-1 position-absolute m-1 bottom-0 end-0 m-2 ' + getUserCounterColor() }
                                    gap={ 1 }>
                                    { roomData.userCount }
                                </Flex>
                            </Column>
