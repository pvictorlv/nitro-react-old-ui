            ...
            <Flex alignItems="center" justifyContent="between" gap={ 2 } className="nitro-toolbar py-1 px-3">
                <Flex gap={ 2 } alignItems="center">
                    <Flex alignItems="center" gap={ 2 }>
                        ...
                        { isInRoom &&
                            <Base pointer className="navigation-item icon icon-habbo hide-mobile" onClick={ event => VisitDesktop() } /> }
                        { !isInRoom &&
                            <Base pointer className="navigation-item icon icon-house hide-mobile" onClick={ event => CreateLinkEvent('navigator/goto/home') } /> }
