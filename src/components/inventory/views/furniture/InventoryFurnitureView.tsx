...
export const InventoryFurnitureView: FC<InventoryFurnitureViewProps> = props =>
{
    ...
    if (!groupItems || !groupItems.length) return <InventoryCategoryEmptyView
        title={ LocalizeText('inventory.empty.title') } desc={ LocalizeText('inventory.empty.desc') }/>;
            ...
            <Column size={ 5 } overflow="auto">
                <Column overflow="hidden" position="relative">
                    ...
                    { selectedItem && selectedItem.stuffData.isUnique &&
                        <LayoutLimitedEditionCompactPlateView className="top-2 end-2" position="absolute"
                ...
                { selectedItem &&
                    <Column grow justifyContent="between" gap={ 2 }>
                        ...
                        <Text grow truncate>{ selectedItem.description }</Text>
                        <Column gap={ 1 }>
                            { !!roomSession &&
